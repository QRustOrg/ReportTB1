...
| **Favorites**    | Permite a los usuarios guardar promociones de interés para consultarlas o utilizarlas posteriormente, facilitando el seguimiento de ofertas relevantes.                          | `PromocionGuardada`, `PromocionEliminadaFavoritos`, `FavoritosConsultados`                |
...
| **Notifications** | Gestiona el envío de notificaciones hacia los usuarios (nuevas promociones, recordatorios de uso y actualizaciones del sistema), utilizando mensajes internos.                  | `NotificacionEnviada`, `NotificacionLeida`, `NotificacionProgramada` |
| **Settings**      | Administra las configuraciones y preferencias del usuario, como notificaciones, privacidad, idioma y permisos, permitiendo personalizar la experiencia dentro de la plataforma. | `ConfiguracionModificada`, `PermisoActualizado`                      |
